...
<html lang="en">
  ...
  <section id="container" >
    ...
    while($res = mysqli_fetch_array($result)) {   
      $encrypted_jobid = $res['encrypted_jobid'];
      $encrypted_var1 = $cipher->encrypt($encrypted_jobid);
      $encrypted_opnum = $res['encrypted_opnum'];
      $encrypted_var2 = $cipher->encrypt($encrypted_opnum);
        echo "<tr>";
        echo "<td>".$encrypted_var1."</td>";
        echo "<td>".$encrypted_var2."</td>";
...
<br>
         <a href="decrypted-data.php"><button class="btn btn-primary" style="float:right" href="decrypted-data.php">Decrypt Data</button></a>
